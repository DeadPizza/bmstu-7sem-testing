...
#line hidden
        ...
        public ResetPasswordFeature(ResetPasswordFeature.FixtureData fixtureData, E2E_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "ResetPassword", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Resetting a user\'s password")]
        [Xunit.TraitAttribute("FeatureTitle", "ResetPassword")]
        [Xunit.TraitAttribute("Description", "Resetting a user\'s password")]
        public void ResettingAUsersPassword()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Resetting a user\'s password", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 2
